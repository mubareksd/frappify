...
class _SoCupertinoLocalizationsDelegate
  ...
  Future<CupertinoLocalizations> load(Locale locale) {
    ...
    return SynchronousFuture<CupertinoLocalizations>(SoCupertinoLocalization(
...
class SoCupertinoLocalization extends GlobalCupertinoLocalizations {
  /// Create an instance of the translation bundle for Afar.
  ///
  /// For details on the meaning of the arguments, see [GlobalCupertinoLocalizations].
  const SoCupertinoLocalization({
