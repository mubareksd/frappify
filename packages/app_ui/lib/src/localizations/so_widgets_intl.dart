...
class _SoWidgetsLocalizationsDelegate
  ...
  @override
  bool shouldReload(_SoWidgetsLocalizationsDelegate old) => false;
}

class SoWidgetsLocalization extends GlobalWidgetsLocalizations {
  ...
  const SoWidgetsLocalization() : super(TextDirection.ltr);
