...
const Map<String, String> soLocaleDatePatterns = <String, String>{
  'd': 'd',
  'E': 'ccc',
  'EEEE': 'cccc',
  'LLL': 'LLL',
...
const Map<String, Object> soDateSymbols = <String, Object>{
  'NAME': 'so',
  'ERAS': <String>[
    'ዓ/ዓ',
    'ዓ/ም',
...
class _SoMaterialLocalizationsDelegate
  ...
  Future<MaterialLocalizations> load(final Locale locale) async {
    ...
    date_symbol_data_custom.initializeDateFormattingCustom(
      locale: localeName,
      patterns: soLocaleDatePatterns,
      symbols: intl.DateSymbols.deserializeFromMap(soDateSymbols),
    );
