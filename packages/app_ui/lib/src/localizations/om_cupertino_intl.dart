...
class _OmCupertinoLocalizationsDelegate
  ...
  Future<CupertinoLocalizations> load(Locale locale) {
    ...
    return SynchronousFuture<CupertinoLocalizations>(OmCupertinoLocalization(
...
class OmCupertinoLocalization extends GlobalCupertinoLocalizations {
  /// Create an instance of the translation bundle for Afar.
  ///
  /// For details on the meaning of the arguments, see [GlobalCupertinoLocalizations].
  const OmCupertinoLocalization({
